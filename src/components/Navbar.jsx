      ...
      <div className="2xl:w-[1280px] xl:w-10/12 w-11/12 flex justify-between items-center relative">
        ...
        >
          <div className="grow basis-0 justify-end hidden lg:flex">
            <a
              className="text-white custom-border-gray rounded-full
           bg-customDarkBg2 hover:bg-customDarkBg3  border-gray-700 hover:border-customSecondary pl-6 pr-8 pt-2 pb-2 text-sm flex"
