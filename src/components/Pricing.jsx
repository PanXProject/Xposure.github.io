                ...
                <div className="p-8 bg-customDarkBg3 rounded-3xl">
                  ...
                  <div className="flex justify-start items-end">
                    ...
                    <div className="text-gray-500">
                      {isMonthly ? "Monthly per location" : "Monthly per location"}
                    </div>
                  </div>
                  ...
                  <a
                    ...
                    href="https://xp.panx.io/plan-signup"
                  >
                    Get Started
                  </a>
                </div>
